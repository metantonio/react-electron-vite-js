...
const MyTestComponent = () => {
    ...
    const downloadBlob = (blob, filename) => {
        ...
        window.electron.ipcRenderer.send(`downloading ${blob}`)
    }
                                        ...
                                        return (<div key={index}>
                                            <strong>
                                                <button
                                                    ...
                                                    onClick={async (e) => {
                                                        downloadBlob(`${URL_DOWNLOAD}${item.document.doc_metadata.file_name}`, item.document.doc_metadata.file_name)
    ...
    useEffect(() => {
        const newSocket = io(store.baseURL2, {
